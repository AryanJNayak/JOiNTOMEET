...
const CreateSchedule = ({ navigation, route }) => {
    ...
    const SendDateToBackEnd = async () => {
        ...
        if (!data.email || !data.password || !data.id || !data.name) {
    ...
    return (
        ...
        >
                ...
                isLoad ?
                    <View style={styles.containerLoad}>
                        <View style={styles.mainLoader}>
                            ...
                            <Text style={styles.indicatorText}>Creating Schedule...</Text>
                        </View>
                    </View> :
                    null
            }
            ...
            {/* heading JOiNTOMEET */}
            < Text style={styles.headingJoinToMeet} > Create Schedule</Text >
